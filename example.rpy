...
label mod_screen_manager_init:
    ...
    # Важно: проверяем, что в нашем имени сохранения будет присутствовать MOD_SAVE_IDENTIFIER или MOD_NAME из конфига мода, по нему он проверяем мод, сейв которого мы грузим.
    ...
    $ save_name = "Менеджер модов"#"Тест замены интерфейса с помощью менеджера экранов"
